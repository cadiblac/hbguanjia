    ...
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal adminex-form" action="<?php echo U(MODULE_NAME.'/System/updatapwd');?>" method="post">
                    
					<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">账号:</label>
                        <div class="col-sm-10">
                            <span class="form-control" style="border:0;"><?php echo ($username); ?></span>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">用户名:</label>
                        <div class="col-sm-10">
                           <span class="form-control" style="border:0;"><?php echo (session('name')); ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">请输入新密码:</label>
                        <div class="col-sm-10">
                            <input type="password" name="password" style="width: 400px;" class="form-control" placeholder="需包含字母数字,长度为6-20位">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">再次输入新密码:</label>
                        <div class="col-sm-10">
                            <input type="password" name="repassword" style="width: 400px;" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
