                ...
                <section class="mail-box-info">
                   <div class="col-sm-12">
					...
					<header class="panel-heading">
						<?php echo ($cate['name']); ?><span class="text-muted">——发布产品</span>
						<span class="tools pull-right">
							<a class="fa fa-rotate-left" href="<?php echo U(MODULE_NAME.'/Goods/index',array('id' =>$cid));?>"> 返回</a>
						 </span>
					</header>
					<div class="panel-body">
						<div class="form">
							<form class="cmxform form-horizontal adminex-form" method="post" action="<?php echo U(MODULE_NAME.'/Goods/runAdd');?>">
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										...
										<dl id="ul_pic" class="ul_pic clearfix"></dl>
									</div>
								</div>
								<div class="form-group ">
									...
									<div class="col-lg-2">
									<div class="input-group">
										<input class="form-control " type="text" name="memprice" />
										<span class="input-group-addon ">元</span>										
									</div>
								...
								<div class="form-group ">									
									...
									<div class="col-lg-2">
										<div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="<?php echo (date('Y-m-d H:i:s',(isset($v["time"]) && ($v["time"] !== ""))?($v["time"]):time())); ?>"  class="input-append date dpYears" style="width:200px;">
										  <input type="text" name="time" readonly="" value="<?php echo (date('Y-m-d H:i:s',(isset($v["time"]) && ($v["time"] !== ""))?($v["time"]):time())); ?>" size="16" class="form-control">
