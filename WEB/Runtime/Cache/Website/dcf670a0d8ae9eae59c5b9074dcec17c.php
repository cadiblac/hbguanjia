            ...
            <div class="mail-box">
                ...
                <section class="mail-box-info">
                   <div class="col-sm-12">
					...
					<tbody>
					<?php if(is_array($searchg)): foreach($searchg as $key=>$v): ?><tr class="gradeX">
						<td><?php echo ($v["id"]); ?></td>
						<td><?php echo (msubstr($v["title"],0,30,'utf-8',false)); ?></td>
						<td>产品</td>
						<td><?php echo (date('y-m-d H:i:s',$v["time"])); ?></td>						
						<td>
						<a href="<?php echo U(MODULE_NAME.'/Goods/updata',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-success btn-xs">修改</span></a>
						<a onclick="return confirm('确实要删除吗？')" href="<?php echo U(MODULE_NAME.'/Goods/toTrash',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-warning btn-xs">删除</span>
						</td>
					</tr><?php endforeach; endif; ?>
					<?php if(is_array($works)): foreach($works as $key=>$v): ?><tr class="gradeX">
						<td><?php echo ($v["id"]); ?></td>
