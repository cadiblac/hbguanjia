...
<title>添加<?php echo ($str); ?>栏目</title>
<!--file upload-->
                ...
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" method="post" action="<?php echo U(MODULE_NAME.'/Cate/addCateHandle');?>">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-3">
                                            <input class=" form-control" id="lastname" name="en" type="text"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="password" name="keywords" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="confirm_password" class="control-label col-lg-2">栏目描述</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="confirm_password" name="description" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
									...
									<div class="form-group m_Url" style="display:none;">
                                        <label for="email" class="control-label col-lg-2">跳转地址</label>
                                        <div class="col-lg-3">
                                            <input class="form-control " id="email" name="link" type="text" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="email" class="control-label col-lg-2">是否导航显示</label>
                                        <div class="col-lg-3">
                                            <label class="checkbox-inline"><input name="stauts" type="radio" value="0" checked="checked"/>&nbsp;显示&nbsp;&nbsp;
											<input name="stauts" type="radio" value="1" />&nbsp;不显示</label>
                                        </div>
                                    </div>
                                    <div class="form-group ">
