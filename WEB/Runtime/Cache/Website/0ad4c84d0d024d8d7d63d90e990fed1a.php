            ...
            <div class="mail-box">
                ...
                <section class="mail-box-info">
                   <div class="col-sm-12">
                    ...
                    <div class="btn-group">
                        <a target="_parent" href="<?php echo U(MODULE_NAME.'/Atlas/add',array('cid'=>$id));?>" class="btn btn-primary">
                            添加图集 <i class="fa fa-plus"></i>
                        </a>
                    </div>
					</div><?php endif; ?>
					...
					<?php if(is_array($article)): foreach($article as $key=>$v): ?><tr class="gradeX">
						...
						<td>
						<a href="<?php echo U(MODULE_NAME.'/Atlas/updata',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-success btn-xs">修改</span></a>
						<a onclick="return confirm('确实要删除吗？')" href="<?php echo U(MODULE_NAME.'/Atlas/toTrash',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-warning btn-xs">删除</span>						
						</td>
