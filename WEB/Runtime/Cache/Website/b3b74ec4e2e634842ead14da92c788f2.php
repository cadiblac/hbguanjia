                            ...
                            <div class="adv-table editable-table ">
								<div class="clearfix">
									<div class="form-group">
										<a type="button" onClick="location.href = '/index.php/Website/Bak/index/Action/backup'" class="btn btn-primary">
											备份数据 <i class="fa fa-save"></i>
										</a>
									</div>
								</div>
								...
								<?php if(!empty($lists)): if(is_array($lists)): foreach($lists as $key=>$row): if($key > 1): ?><tr>
												...
												<td>
													<a href="<?php echo U('Bak/index',array('Action'=>'download','file'=>$row));?>"><span class="btn btn-success btn-xs">下载</span></a>
												<?php if($_SESSION['username'] == C('RBAC_SUPERADMIN')): ?><a onclick="return confirm('确定将数据库还原到当前备份吗？')"href="<?php echo U('Bak/index',array('Action'=>'RL','File'=>$row));?>"><span class="btn btn-primary  btn-xs">还原</span></a><?php endif; ?>
													<a onclick="return confirm('确定删除该备份文件吗？')"href="<?php echo U('Bak/index',array('Action'=>'Del','File'=>$row));?>"><span class="btn btn-warning btn-xs">删除</span></a>
												</td>
