...
<!--ios7-->
    ...
    <link href="/WEB/Website/public/js/iCheck/skins/minimal/red.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/minimal/green.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/minimal/blue.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/minimal/yellow.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/minimal/purple.css" rel="stylesheet">
    ...
    <link href="/WEB/Website/public/js/iCheck/skins/square/green.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/square/blue.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/square/yellow.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/square/purple.css" rel="stylesheet">

    <link href="/WEB/Website/public/js/iCheck/skins/flat/grey.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/flat/red.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/flat/green.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/flat/blue.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/flat/yellow.css" rel="stylesheet">
    <link href="/WEB/Website/public/js/iCheck/skins/flat/purple.css" rel="stylesheet">

    <!--multi-select-->
    <link rel="stylesheet" type="text/css" href="/WEB/Website/public/js/jquery-multi-select/css/multi-select.css" />

    <!--file upload-->
    <link rel="stylesheet" type="text/css" href="/WEB/Website/public/css/bootstrap-fileupload.min.css" />

    <!--tags input-->
    <link rel="stylesheet" type="text/css" href="/WEB/Website/public/js/jquery-tags-input/jquery.tagsinput.css" />
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
				...
				<li>
                    <a href="<?php echo U('Rbac/role');?>">角色管理</a>
                </li>
        ...
        <div class="wrapper">
            <div class="row">
                <div class="col-md-12">
				<div class="form">
				<form class="cmxform form-horizontal adminex-form" method="post" action="<?php echo U(MODULE_NAME.'/Rbac/setAccess');?>" >
					<?php if(is_array($node)): foreach($node as $key=>$app): ?><section class="panel panel-primary">
						...
						<div class="flat-yellow single-row">
							<div class="radio ">
                            <input type="checkbox" name="access[]" value="<?php echo ($app["id"]); ?>_1" level='1' checked />
							<?php echo ($app["title"]); ?>
							</div>
						</div>
						</div>
							<span class="tools pull-right">
                                <a class="fa fa-rotate-left" href="<?php echo U(MODULE_NAME.'/Rbac/role');?>"> 返回</a>
                             </span>
                        ...
                        <div class="panel-body"><div class="alert alert-success alert-block fade in">注意:若要选择子项，必先选择其父项，子项才能生效！</div>
							...
							<div class="panel panel-info">
								...
								<div class="col-sm-3 icheck">
									<div class="flat-yellow single-row">
										<div class="radio "><?php echo ($action["title"]); ?>
								...
								<?php if(is_array($action["chlid"])): foreach($action["chlid"] as $key=>$method): ?><div class="col-sm-3 icheck">
...
<!--ios7-->
<script src="/WEB/Website/public/js/ios-switch/switchery.js" ></script>
<script src="/WEB/Website/public/js/ios-switch/ios-init.js" ></script>

<!--icheck -->
<script src="/WEB/Website/public/js/iCheck/jquery.icheck.js"></script>
<script src="/WEB/Website/public/js/icheck-init.js"></script>
<!--multi-select-->
<script type="text/javascript" src="/WEB/Website/public/js/jquery-multi-select/js/jquery.multi-select.js"></script>
<script type="text/javascript" src="/WEB/Website/public/js/jquery-multi-select/js/jquery.quicksearch.js"></script>
<script src="/WEB/Website/public/js/multi-select-init.js"></script>
<!--spinner-->
<script type="text/javascript" src="/WEB/Website/public/js/fuelux/js/spinner.min.js"></script>
<script src="/WEB/Website/public/js/spinner-init.js"></script>
<!--file upload-->
<script type="text/javascript" src="/WEB/Website/public/js/bootstrap-fileupload.min.js"></script>
<!--tags input-->
<script src="/WEB/Website/public/js/jquery-tags-input/jquery.tagsinput.js"></script>
<script src="/WEB/Website/public/js/tagsinput-init.js"></script>
<!--bootstrap input mask-->
<script type="text/javascript" src="/WEB/Website/public/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
