...
<script type="text/javascript">
	...
	function deli (id) {
			var handleUrl = '<?php echo U(MODULE_NAME."/Atlas/deli");?>'
                ...
                <section class="mail-box-info">
                   <div class="col-sm-12">
					...
					<header class="panel-heading">
						<?php echo ($cate['name']); ?><span class="text-muted">——发布图集</span>
					...
					<div class="panel-body">
						<div class="form">
							<form class="cmxform form-horizontal adminex-form" method="post" action="<?php echo U(MODULE_NAME.'/Atlas/runAdd');?>">
								...
								<div class="form-group ">
									...
									<div class="col-lg-2">
										<div data-date-viewmode="years" data-date-format="yyyy-mm-dd hh:mm" data-date="<?php echo (date('Y-m-d H:i',(isset($v["time"]) && ($v["time"] !== ""))?($v["time"]):time())); ?>"  class="input-append date dpYears" style="width:200px;">
