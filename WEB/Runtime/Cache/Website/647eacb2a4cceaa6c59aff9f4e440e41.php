            ...
            <div class="mail-box">
                ...
                <section class="mail-box-info">
                   <div class="col-sm-12">
					...
					<tbody>
					<?php if(is_array($gbook)): foreach($gbook as $key=>$v): ?><tr class="gradeX">
						<td><?php echo ($v["id"]); ?></td>
						<td><?php echo ($v["title"]); ?></td>
						<td><?php echo (date('y-m-d H:i',$v["time"])); ?></td>
						<td><?php if($v["reuser"] == ""): ?>未处理<?php else: ?>已处理<?php endif; ?></td>
						<td>
						<a href="<?php echo U(MODULE_NAME.'/Gbook/replay',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-success btn-xs">查看</span></a>
						<a onclick="return confirm('确实要删除吗？')" href="<?php echo U(MODULE_NAME.'/Gbook/delete',array('id'=>$v['id'],'cid'=>$v['cid']));?>"><span class="btn btn-warning btn-xs">删除</span>						
						</td>
