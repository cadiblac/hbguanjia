        ...
        <div class="wrapper">
            <div class="row">
			   <div class="col-sm-12">
				...
				<tbody>
				<?php if(is_array($orders)): foreach($orders as $key=>$v): ?><tr class="gradeX">
					<td><?php echo ($v["order"]); ?></td>
					<td><?php echo (msubstr($v["pname"],0,12,'utf-8',false)); ?></td>
					<td><?php echo ($v["price"]); ?>元</td>
					<td><?php echo ($v["num"]); ?></td>
				    <td><?php echo ($v["sumprice"]); ?>元</td>
					<td>
					<?php switch($v['status']): case "0": ?>购物车<?php break;?>
