        ...
        <div class="wrapper">
            <div class="row">
			   <div class="col-sm-12">
				...
				<tbody>
				<?php if(is_array($clist)): foreach($clist as $key=>$v): ?><tr class="gradeX">
					<td><?php echo ($v["fz"]); ?></td>
					<td><?php echo ($v["c"]); ?></td>
					<td><?php echo ($v["s"]); ?></td>
					<td>
					<a href="<?php echo U(MODULE_NAME.'/Comment/lists',array('fz'=>$v['fz']));?>"><span class="btn btn-success btn-xs">管理</span></a>
					</td>
