    ...
    <section class="service-section normal-layer no-padding-layer i-border-image">
        <ul class="feature-list interaction-list">
            <li class="feature-item">                
                <p class="inner-bar"><span class="order-text">我的积分<em id="orderInfo"></em></span><span class="tip-right text-success"><b><?php echo ($member["integral"]); ?></b></span></p>
            </li>
			<?php if(is_array($jf)): foreach($jf as $key=>$v): ?><li>
				<div class="padding5">
				<p><b><?php if($v['stutas']): ?><span class="green">增加</span><?php else: ?><span class="red">消费</span><?php endif; ?></b>&nbsp;积分：<?php echo ($v["jf"]); ?><span class="fr"><?php echo (date('Y-m-d H:i:s',$v["time"])); ?></span></p>
