var uploadar = new plupload.Uploader(
      {
     ...
     var percent = file.percent;
        ...
        FileUploaded: function(up, file, info) { //文件上传成功的时候触发
           var data = eval("(" + info.response + ")");
            $("#d" + file.id).html("<img src='" + data.pic + "'/><input name='pic[]' class='dis' id='p"+file['id']+"'><p class='del'>删除</p>");
			//var old=$("#pics").val();
...
uploadar.init();
var uploadar2 = new plupload.Uploader(
      {
		runtimes: 'html5,flash,silverlight,html4', //上传插件初始化选用那种方式的优先级顺序
